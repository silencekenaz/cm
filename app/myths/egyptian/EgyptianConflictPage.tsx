...
const cast = [
  ...
  },
  {
    ...
    body: "欧西里斯的兄弟、荷鲁斯的叔父，也是风暴、荒漠、异域与猛烈力量的神。他的王位论据并不只是“我更强”：他强调自己每日站在百万年之船的前方，击杀太阳神的敌人，而别的神做不到。因此赛特代表一种真实且不可缺少的宇宙能力，只是这种能力不足以取代继承法。故事最终没有消灭他，而是把雷霆与威慑重新安置到天空。",
  },
  {
    name: "伊西斯",
    role: "THE STRATEGIST / 保护者与谋略者",
    image: "egypt-god-isis.webp",
    body: "她以魔法、辩辞与母职贯穿整个谱系：取得拉的隐名，寻找并重整欧西里斯的尸身，在三角洲保护幼年荷鲁斯，又以变形、寓言、贿赂和证据设计迫使法庭前进。她既会算计，也会因亲缘而心软；在河马比试中放过兄弟赛特，反而激怒儿子。伊西斯从来不是站在男性英雄身后哀悼的人，她本身就是继承权得以成立的行动者。",
  },
  {
    name: "欧西里斯",
  ...
  },
  {
    ...
    body: "作为太阳神与会议的最高权威，他主持审理，却明显欣赏赛特保卫太阳船的力量，并多次质疑年轻的荷鲁斯。他会被巴巴一句冒犯的话气得退庭，也会被哈托尔逗笑后重新开庭；他甚至与欧西里斯隔着生死领域互致尖锐书信。正因为最高权威也会偏爱、动摇与维护自尊，这个故事才不是答案预先写好的道德题。",
  },
  {
    name: "托特",
    role: "THE SCRIBE / 书记与证据召唤者",
    image: "egypt-god-thoth.webp",
    body: "他是九神法庭的书记、书信起草者和最稳定的程序维护者。开庭之初，他便称荷鲁斯的主张“正确百万次”；之后又代太阳神写信给涅伊特与欧西里斯。在最离奇的一场证明中，他召唤双方的精液回答，并把从赛特额头出现的金色圆盘取作自己的冠饰。托特并不总能直接裁决，却不断让发言变成文书、身体变成证据、僵局变成可追责的记录。",
  },
];

const supportingFigures = [
  ["舒", "FIRST OPINION", "最早公开支持荷鲁斯的发言者之一。他把问题表述为“正义具有力量”，并在末段赞同向欧西里斯发函。"],
  ["涅伊特", "THE ELDER VERDICT", "居于塞易斯的古老女神。她在回信中要求把欧西里斯的职位交给荷鲁斯，同时以加倍财产和阿娜特、阿斯塔蒂安置赛特。"],
  ["巴涅布杰代特", "THE HESITANT ARBITER", "门德斯的羊神，被召来判断两位竞争者，却拒绝在无知中仓促行动，转而建议询问涅伊特。"],
  ["奥努里斯", "THE PARTISAN", "多次站在荷鲁斯一方。当太阳神轻视年轻请求人时，他与法庭成员一同激烈反对。"],
...
const chapters = [
  {
    ...
    title: "王位空缺，争讼开始",
    body: [
      "故事开始时，荷鲁斯像一位年轻的诉讼人坐在“宇宙之主”面前，请求得到父亲欧西里斯的王位。舒首先主张把职位交给他，托特立即赞成，说这项判断“正确百万次”；伊西斯欣喜若狂，甚至请北风把好消息送往西方的欧西里斯。法庭一度已经为荷鲁斯戴上白冠，拉—哈拉胡提却对众神擅自行动感到愤怒，赛特也要求以双手的力量当庭决胜。",
      "双方的论据并不完全处于同一层面。荷鲁斯强调父子继承：一个身体所生的儿子仍然活着，叔父便不能夺走父位。赛特则强调成年、资历与功能：他自称九神中最强者，每天站在百万年之船前方击杀太阳神的敌人，只有他能承担最危险的宇宙工作。血统的合法性与力量的有效性由此正面冲突。",
      "为了避免在无知中裁断，巴涅布杰代特建议询问居于塞易斯的涅伊特。托特以太阳神名义写信时说，两位竞争者已在法庭前站了八十年，竟仍无人知道如何判决。涅伊特的回信十分明确：把欧西里斯的职位交给荷鲁斯；同时加倍赛特的财产，并把阿娜特与阿斯塔蒂给予他作为补偿。全体九神称她正确，拉—哈拉胡提却依然嫌荷鲁斯四肢软弱、年纪太轻。答案已经出现，执行仍被权威的偏爱挡住。",
    ],
  ...
  },
  {
    ...
    title: "最高权威也会动摇",
    body: [
      "拉—哈拉胡提轻视荷鲁斯的年轻，使奥努里斯与整个九神法庭群情激愤。巴巴用一句近乎亵渎的嘲讽刺伤太阳神的尊严，法庭立即把巴巴赶出会议；拉—哈拉胡提则仰面躺进凉亭，独自闷了一整天，审理也随之停摆。",
      "过了很久，南方无花果树之女哈托尔来到父亲面前，以直接而带有民间喜剧色彩的身体动作使他发笑。太阳神终于重新坐到诸神中间，要求双方再次陈述。赛特于是提出自己最有分量的论据：他每天击杀太阳船的敌人，九神中无人能代替。众神一度被说服，托特与奥努里斯马上反问：儿子尚在，职位怎能交给母系一侧的兄弟？会议再次分裂。",
      "赛特随后以沉重权杖威胁每天杀死一名法庭成员，并要求伊西斯不得出席。最高权威接受了这一条件，把审判迁到“中央之岛”。这不是无关的闹剧，而是一幅尖锐的制度画像：情绪可以令法庭休会，威胁可以改变地点，程序本身也可能被强者操纵。",
    ],
  ...
  },
  {
    ...
    body: [
      ...
      "赛特独自追到树后。伊西斯向他讲述一宗假案：自己的牧人丈夫死了，儿子本应接管父亲的牲畜；一个外来者却闯进牛栏，扬言殴打孩子、夺走牛群并把他赶出去。赛特毫不犹豫地回答：父亲的牲畜怎能交给外人，而让亲生儿子活着受夺？外人应受杖击，儿子应被安置在父亲的位置。",
      "伊西斯立刻化为鸢，飞上金合欢树，宣告是赛特自己的嘴和聪明才智判决了他。赛特哭着回到拉—哈拉胡提面前复述经过，太阳神也只能指出：你已经裁定了自己。安提因受贿被拖来惩罚；文本说他的脚掌被除去，并让他立誓从此憎恶黄金。一次继承寓言由此顺带解释了地方性的禁金传统。",
    ],
    note: "原文在“牲畜”与“王位／职位”之间使用双关。伊西斯不是说服赛特接受新原则，而是让他在认不出自身案件时说出早已承认的原则。",
  },
  {
    number: "04",
    ...
    title: "河马比试与母子决裂",
    body: [
      "自我判决之后，太阳神与阿图姆终于下令把白冠戴在荷鲁斯头上。赛特却拒绝承认第一次加冕，要求取下王冠、把荷鲁斯投入水中，再以比赛决定职位。他提出两神化作河马，潜入“大绿海”三个月；谁在期限前浮出，谁就被取消王位资格。法庭竟再次接受了把已经做出的裁决交给身体竞赛。",
      "伊西斯坐在岸边哭泣，以纱线搓绳，熔化一磅铜铸成带倒钩的水中武器。她投出鱼叉，第一击误中荷鲁斯；听见儿子呼喊，她命鱼叉松开。第二击刺中赛特，赛特不是凭政治理由求情，而是唤她“同母的姐姐”。伊西斯对兄弟生出怜悯，再次命鱼叉松开。",
  ...
  },
  {
    ...
    title: "受伤的眼睛重新完整",
    body: [
      "九神进入山地搜捕荷鲁斯时，他正躺在绿洲的一棵树下。赛特先找到他，把他仰面按倒，挖出两只眼睛并埋在山中，然后回到太阳神面前谎称没有找到荷鲁斯。被埋的眼球却化作两枚球茎，长成莲花，仿佛失去的天体之光转入大地，又从植物中重新出现。",
      "哈托尔在沙漠中找到哭泣的荷鲁斯。她挤取羚羊乳，依次滴入他的左右眼眶，命他睁眼；荷鲁斯恢复视力以后，她才回到法庭揭露赛特的所为。太阳神要求两人停止每日争吵、同桌吃喝、重新和解，这一过早的和平提议随即把故事引向下一场更隐秘的攻击。",
      "后来极为重要的“荷鲁斯之眼”在不同传统里拥有不止一种受伤与复原叙事：更古老的材料常说赛特夺去一眼，荷鲁斯则伤害赛特的睾丸；本长篇却写双眼被挖，并让哈托尔而非托特完成治疗。差异提醒读者，神话意象会被不同文本反复重组。",
    ],
  ...
  },
  {
    ...
    title: "身体被带进法庭",
    body: [
      "在太阳神要求两人和平相处之后，赛特邀请荷鲁斯到自己家中“快乐地过一天”。夜里，他试图通过性行为把主动支配变成王位资格的证据；荷鲁斯却用双手接住赛特的精液，没有让它进入身体。他回到伊西斯身边展示证据，伊西斯惊叫着切下受污染的手，把它扔进沼泽，并以魔法为儿子补造一只等值的新手。",
      "伊西斯随后取得荷鲁斯的精液，清晨来到赛特的菜园。她询问园丁赛特平日唯一会吃什么植物，答案是莴苣；她便把精液放在莴苣上。赛特照常吃下，文本直言他因此怀上荷鲁斯的种子。古埃及莴苣切口会流出乳白汁液，又与生殖神敏相关，所以这项反制并非随意选择的现代笑料。",
      "到了法庭，赛特宣称自己对荷鲁斯完成了“勇士之事”。众神朝荷鲁斯吐唾沫，荷鲁斯却笑着要求召唤双方的精液。托特呼唤赛特的精液，它从沼泽中的弃手回答；呼唤荷鲁斯的精液时，它拒绝从赛特耳朵出来，选择从额头升起，化作一轮金色太阳。赛特伸手抢夺，托特却把圆盘取走，戴在自己头上。法庭再次宣布荷鲁斯正确、赛特错误。",
    ],
  ...
  },
  {
    ...
    title: "一艘看起来像石头的木船",
    body: [
      "身体证据再次判赛特败诉，他却立誓在与荷鲁斯完成另一场比试以前绝不交出职位：两人各造一艘石船赛航，胜者才成为统治者。荷鲁斯没有正面违抗规则。他趁夜用杉木造船，外覆石膏，使旁人看见的材料与船真正的材料分离。赛特看到船身，以为对手果然造了石船。",
      "赛特走向山中，切下一块山峰，凿成一艘一百三十八肘长的石船。当两人在九神面前下水，赛特的真石船立刻沉没；他随即化作河马，让荷鲁斯的船也倾覆。荷鲁斯举起鱼叉，准备把比赛重新变成杀戮，九神却命令他不得投掷。",
      "荷鲁斯收起水中武器，亲自前往塞易斯向涅伊特申诉。他列举自己在“真理之路”“角前的荷鲁斯”“芦苇原”等多个审判厅一次次获判正确，却仍得不到执行。这一串地点让八十年不再只是夸张数字：案件仿佛已经遍历整个神圣司法地理。",
    ],
    note: "这场比试有近乎民间故事的机智。荷鲁斯没有比赛谁更能搬动石头，而是识别出赛特把“服从规则的字面”误当成“实现规则的目的”。",
  },
  {
    number: "08",
    ...
    body: [
      ...
      "众神承认欧西里斯正确。赛特仍要求再到中央之岛争辩，但这一次荷鲁斯正式胜诉。阿图姆命伊西斯把赛特捆成囚徒带来，问他为何持续阻挠裁决、攫取荷鲁斯的职位。赛特终于亲口请求召来荷鲁斯，把父位交给他。白冠再次落在荷鲁斯头上，诸神称他为两地的好王；伊西斯高声欢呼，九神戴上花环，整片土地一同庆祝。",
      "普塔最后追问该如何处置赛特。拉—哈拉胡提把他收作身边的儿子，让他在天空发出雷鸣，使人敬畏。荷鲁斯取得王位，赛特取得与其危险力量相称的位置；故事以“在底比斯、真理之地圆满结束”的抄写语收尾。结局不是善把恶抹去，而是让继承、死亡、太阳与风暴重新各居其位。",
    ],
    note: "最终裁决之所以有效，不只是因为又出现一条新证据，而是赛特被强制带到权威面前，并亲口停止阻挠。程序终于获得了执行力。",
  },
];
