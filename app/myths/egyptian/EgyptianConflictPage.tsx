...
const chapters = [
  ...
  },
  {
    ...
    body: [
      ...
      "过了很久，南方无花果树之女哈托尔来到父亲面前，以直接而带有民间喜剧色彩的身体动作使他发笑。太阳神终于重新坐到诸神中间，要求双方再次陈述。塞特于是提出自己最有分量的论据：他每天击杀太阳船的敌人，九神中无人能代替。众神一度被说服，托特与奥努里斯马上反问：儿子尚在，职位怎能交给母系一侧的兄弟？会议再次分裂。",
