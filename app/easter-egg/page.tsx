...
const fragments = [
  ...
  },
  {
    ...
    title: "小沙沙巡城，小红毛布局",
    text: "女王的吉祥物小沙沙平日伏在王座上方的旧旗穗间，入夜后便沿城墙巡行，能从石砖的震动与风声中分辨蛮夷车队的方向。公主的吉祥物小红毛则是纯粹的脑力派：不擅长正面作战，却精于设局、伪造情报与反向推演，常在所有人看懂棋盘以前改变胜负。他名义上跟随公主，阵营却从未固定；有时替酸菜国诱敌深入，有时又会为自己的计划反坑酸菜。因此王室采纳小红毛的计谋时，总会同时准备一份防备小红毛的备用方案。",
  },
];
